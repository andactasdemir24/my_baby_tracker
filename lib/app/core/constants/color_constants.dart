...
//settings
  static Color settingsIndex = const Color(0xffc2c2c2);

//feeding icon color
  static Color feedindIconColor = const Color(0xff9B64FF);
//symptomps icon color
  static Color symptompsIconColor = const Color(0xffFFC664);
// calender icon color
...
//grey shade
  ...
  static Color shade200 = Colors.grey.shade200;
  static Color shade300 = Colors.grey.shade300;
